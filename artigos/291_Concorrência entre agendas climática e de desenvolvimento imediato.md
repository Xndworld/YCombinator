# Concorrência entre agendas climática e de desenvolvimento imediato
## Uma Análise Profunda de Oportunidade de Negócio

**Classificação: OPORTUNIDADE MODERADA**
**Ranking: #291 de 498 problemas analisados**
...
Governos enfrentam trade-offs entre investir em adaptação e atender demandas sociais urgentes.

Em contextos de pobreza e desigualdade, projetos de longo prazo disputam orçamento com programas de transferência de renda, saúde básica e segurança pública; sem mecanismos internacionais de financiamento dedicados, a transição tende a ser adiada em favor de respostas de curto prazo.
...
O problema "Concorrência entre agendas climática e de desenvolvimento imediato" não existe em isolamento. Ele é produto de forças estruturais que convergem em um momento específico da história econômica e social. Para entendê-lo plenamente, é necessário analisar suas múltiplas dimensões.
...
| Monetização e Viabilidade de Negócio | 147/260 | 56.5% |
...
- [███████░░░] **Urgência percebida**: 7/10 (peso 4)
  Análise heurística: palavras-chave detectadas - urgente, imediato
...
### Monetização e Viabilidade de Negócio (56.5%)

- [███████░░░] **Disposição a Pagar / WTP**: 7/10 (peso 5)
  Análise heurística: palavras-chave detectadas - investir, orçamento
...
1. **Urgência percebida** (7/10, peso 4): Análise heurística: palavras-chave detectadas - urgente, imediato
2. **Disposição a Pagar / WTP** (7/10, peso 5): Análise heurística: palavras-chave detectadas - investir, orçamento
3. **Tempo de adoção / Aha Moment** (6/10, peso 3): Análise heurística: palavras-chave detectadas - imediato
4. **Orçamento pré-existente** (6/10, peso 4): Análise heurística: palavras-chave detectadas - orçamento
5. **Ciclo de Vendas B2B** (6/10, peso 3): Análise heurística: palavras-chave detectadas - imediato
...
A categoria mais forte deste problema é **Monetização e Viabilidade de Negócio** (56.5%), sugerindo que as condições de mercado e contexto são particularmente favoráveis nesta dimensão.
...
"Concorrência entre agendas climática e de desenvolvimento imediato" representa uma oportunidade classificada como **OPORTUNIDADE MODERADA** (#291 de 498). Com pontuação de 51.4% no framework de avaliação, o problema demonstra potencial moderado que requer cuidado na execução e validação rigorosa.
