# Degradação de infraestrutura urbana em bairros populares
## Uma Análise Profunda de Oportunidade de Negócio

**Classificação: OPORTUNIDADE MODERADA**
**Ranking: #397 de 498 problemas analisados**
...
Bairros de baixa renda sofrem com saneamento precário, iluminação insuficiente e equipamentos públicos degradados.

Investimentos se concentram em zonas centrais e projetos de prestígio, enquanto áreas periféricas acumulam déficit histórico; isso alimenta ciclos de violência, doenças e baixa escolaridade, tornando mais difícil a mobilidade social e a atração de negócios legítimos.
...
O problema "Degradação de infraestrutura urbana em bairros populares" não existe em isolamento. Ele é produto de forças estruturais que convergem em um momento específico da história econômica e social. Para entendê-lo plenamente, é necessário analisar suas múltiplas dimensões.
...
2. **Densidade de dados disponíveis** (6/10, peso 3): Análise heurística: palavras-chave detectadas - dados
3. **Orçamento pré-existente** (6/10, peso 4): Análise heurística: palavras-chave detectadas - investimento
...
"Degradação de infraestrutura urbana em bairros populares" representa uma oportunidade classificada como **OPORTUNIDADE MODERADA** (#397 de 498). Com pontuação de 50.9% no framework de avaliação, o problema demonstra potencial moderado que requer cuidado na execução e validação rigorosa.
