# Crise de habitação acessível em grandes cidades
## Uma Análise Profunda de Oportunidade de Negócio

**Classificação: OPORTUNIDADE MODERADA**
**Ranking: #213 de 498 problemas analisados**
...
Preços de aluguel e compra de imóveis crescem mais rápido que renda em metrópoles, expulsando classes médias e baixas para periferias distantes.

A combinação de crédito restrito, escassez de solo bem servido, gentrificação e uso especulativo de imóveis cria um descolamento estrutural entre custo de moradia e salários, agravando desigualdades urbanas e tempos de deslocamento.
...
O problema "Crise de habitação acessível em grandes cidades" não existe em isolamento. Ele é produto de forças estruturais que convergem em um momento específico da história econômica e social. Para entendê-lo plenamente, é necessário analisar suas múltiplas dimensões.
...
- **Pressão Macroeconômica (7/10):** Análise heurística: palavras-chave detectadas - crise, custo
...
| Validação e Execução Lean | 163/300 | 54.3% |
...
- [███████░░░] **Pressão Macroeconômica**: 7/10 (peso 4)
  Análise heurística: palavras-chave detectadas - crise, custo

- [█████░░░░░] **Janela de Oportunidade**: 5/10 (peso 4)
  Análise heurística: avaliação baseada no contexto geral do problema

### Validação e Execução Lean (54.3%)
...
1. **Pressão Macroeconômica** (7/10, peso 4): Análise heurística: palavras-chave detectadas - crise, custo
...
A categoria mais forte deste problema é **Validação e Execução Lean** (54.3%), sugerindo que as condições de mercado e contexto são particularmente favoráveis nesta dimensão.
...
"Crise de habitação acessível em grandes cidades" representa uma oportunidade classificada como **OPORTUNIDADE MODERADA** (#213 de 498). Com pontuação de 51.7% no framework de avaliação, o problema demonstra potencial moderado que requer cuidado na execução e validação rigorosa.
