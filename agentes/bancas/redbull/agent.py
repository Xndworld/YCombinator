...
from ..base_banca import BaseBanca
from .config import (
    SCORING_FRAMEWORK,
    MAX_POSSIBLE_SCORE,
    THRESHOLD_APROVADO,
...
class RBBJudgeAgent(BaseBanca):
    """
    Agente principal que orquestra o pipeline de avaliação RBB.
    Implementa a interface BaseBanca.
    """
    ...
    def framework_info(self) -> dict:
        ...
        return {
            "nome": "Red Bull Basement",
            "pilares": SCORING_FRAMEWORK,
    ...
    def avaliar(self, limite: Optional[int] = None) -> list:
        """
